ARG SIGNAL_CLI_VERSION=0.14.10
...
RUN cd /tmp/signal-cli-rest-api-src/docs \
	&& wget https://github.com/tvup/signal-cli/releases/download/v${SIGNAL_CLI_VERSION}/signal-cli-${SIGNAL_CLI_VERSION}-json-schemas.tar.gz \
